...
| s = SYMB_PLUS  { Func.from_string s }
| s = SYMB_TIMES { Func.from_string s }
| s = SYMB_MINUS { Func.from_string s }
| s = SYMB_EXP   { Func.from_string s }
| s = SYMB_LT    { Func.from_string s }
| s = SYMB_GT    { Func.from_string s }
| s = SYMB_EQ    { Func.from_string s }
| s = SYMB_AND   { Func.from_string s }
| s = SYMB_OR   { Func.from_string s }
| s = SYMB_SHARP { Func.from_string s }
| s = SYMB_SLASH { Func.from_string s }
| s = SYMB_BTICK { Func.from_string s }
| s = SYMB_TICK  { Func.from_string s }
...
| s = SYMB_TILDE { Func.from_string s }

%inline extensible_postfix:
| s = SYMB_QMARK { Func.from_string s }
